...
async def stop_crawler():
    ...
    if not _crawler_process or _crawler_process.returncode is not None:
...
async def get_status():
    ...
    if _crawler_process.returncode is None:
